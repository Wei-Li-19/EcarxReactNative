...
import styles from '../../styles/home/DataDetail'
...
class DataMallDetail extends Component {
    ...
    componentDidMount() {
        ...
        dispatch(dataMallAction.getGoodsDetail(navigation.state.params.detail.productId));//navigation.state.params 为上级传递过来的参数
    }
    _goBack() {
    ...
    _renderSwiper = () =>{
        return(
            <View style={styles.banner}>
                {
                  this.props.dataMallData.goodDetail.images
                && this.props.dataMallData.goodDetail.images.length>0
                && <Swiper
                    loop={true}
            ...
            return (
                <View style={styles.container}>
                    <TouchableOpacity style={styles.button} onPress={()=>{this._goBack()}}>
                        <Icon name='ios-arrow-back' color={'#fff'} style={{fontSize:25,paddingRight:2}}/>
                    </TouchableOpacity>
